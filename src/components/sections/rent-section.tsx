        ...
        <div className="grid items-center justify-center gap-2 sm:gap-0 md:grid-cols-12">
          <div className="flex overflow-x-auto pb-4 sm:mx-0 sm:overflow-visible sm:pb-0 md:col-span-5">
            <div className="md::flex-row flex w-full flex-col gap-2 whitespace-nowrap sm:mx-auto md:mx-0 md:block md:gap-0 md:gap-y-1">
              {bikesFeatures.map((feature) => (
                <div
                  key={feature.title}
                  className={cn(
                    "group relative rounded-2xl text-center md:rounded-l-xl md:rounded-r-none md:p-6 md:text-start md:hover:bg-gradient-to-br md:hover:from-primary/20 md:hover:to-fuchsia-400/20",
                    activeFeature === feature
                      ? "md:bg-gradient-to-br md:from-primary/10 md:to-fuchsia-400/10"
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-muted-foreground sm:text-lg sm:leading-6 block">
