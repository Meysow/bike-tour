        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-6">
            ...
            <p className="max-w-3xl mx-auto text-lg text-muted-foreground sm:text-xl sm:leading-8">
              <Balancer>
                We're passionate about helping you discover Paris in the most
                authentic way possible. Our mission is to create unforgettable
                cycling experiences that connect you with the heart and soul of
                the City of Light.
              </Balancer>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg leading-8 text-muted-foreground">
                <Balancer>
                  Founded by passionate Parisians who believe that the best way
                  to experience our beautiful city is on two wheels. We started
                  RentaTour with a simple vision: to make Paris accessible to
                  everyone through guided bike tours and quality bike rentals.
                </Balancer>
              </p>
              ...
              <p className="text-lg leading-8 text-muted-foreground">
                <Balancer>
                  ...
                  magical. We're not just showing you the sights – we're sharing
                  our love for this incredible city.
                </Balancer>
              </p>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                We believe in sustainable tourism. Biking is the greenest way to
                explore Paris while reducing your carbon footprint.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                As locals, we're passionate about sharing the real Paris with
                you. We support local businesses and hidden gems off the beaten
                path.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                We're building a community of cycling enthusiasts who share our
                love for Paris and sustainable transportation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="max-w-2xl mx-auto text-lg text-muted-foreground">
              <Balancer>
                Passionate locals who love sharing their city with visitors from
                around the world.
              </Balancer>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Born and raised in Paris, Pierre knows every corner of the city.
                His passion for cycling and local history makes every tour
                unforgettable.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                tours. She'll show you Paris through the eyes of the great
                masters.
              </p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                condition and can fix anything on the spot. Safety is his middle
                name.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-primary/5 to-fuchsia-400/5">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg text-muted-foreground mb-8">
            <Balancer>
              Whether you're interested in a guided tour or bike rental, we're
              here to help you create the perfect Parisian adventure.
            </Balancer>
          </p>
