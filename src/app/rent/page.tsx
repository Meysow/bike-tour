        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-6">
            ...
            <p className="max-w-3xl mx-auto text-lg text-muted-foreground sm:text-xl sm:leading-8">
              <Balancer>
                Choose from our wide range of bikes, perfect for exploring Paris
                at your own pace. Select the bike that suits your style and hit
                the road with comfort and ease.
              </Balancer>
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="max-w-2xl mx-auto text-lg text-muted-foreground">
              <Balancer>
                Enhance your cycling experience with our selection of essential
                accessories. All available for rent with your bike.
              </Balancer>
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Collect your bike from our shop. We'll provide a safety briefing
                and helmet fitting.
              </p>
            </div>
