        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-6">
            ...
            <p className="max-w-3xl mx-auto text-lg text-muted-foreground sm:text-xl sm:leading-8">
              <Balancer>
                Join us on unforgettable bike tours through the heart of Paris.
                Explore iconic landmarks, discover hidden gems, and experience
                the city like a true Parisian with our expert local guides.
              </Balancer>
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg leading-8 text-muted-foreground">
                <Balancer>
                  Starting in the heart of Paris 💫 we will take you to our most
                  beautiful spots around the city 🚴🏻‍♂️ The tour is a perfect mix
                  between typical Parisian streets and emblematic monuments of
                  the city.
                </Balancer>
              </p>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 lg:order-1">
              ...
              <p className="text-lg leading-8 text-muted-foreground">
                <Balancer>
                  Join us for a nighttime adventure as Paris lights up. See the
                  Eiffel Tower, Champs-Elysées, and the Seine in all their
                  illuminated glory.
                </Balancer>
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h3 className="font-semibold text-lg">Evening Highlights</h3>
                  <ul className="space-y-2 text-muted-foreground">
                    <li className="flex items-center gap-2">
                      <span className="w-2 h-2 bg-primary rounded-full"></span>
